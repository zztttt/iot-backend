...
#参数body: 类型json, 参数不可以为空
#  描述:body,具体参考平台api说明
def CreateFirmware(appKey, appSecret, productId, firmwareName, firmwareVersion, firmwareDesc, createBy, body):
    path = '/aep_firmware_management/firmware'
    head = {}
    param = {'productId':productId, 'firmwareName':firmwareName, 'firmwareVersion':firmwareVersion, 'firmwareDesc':firmwareDesc, 'createBy':createBy}
    version = '20201118083703'
    application = appKey
    key = appSecret
